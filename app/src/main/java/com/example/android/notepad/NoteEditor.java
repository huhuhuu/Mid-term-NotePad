        ...
        if (mCursor != null) {
            ...
            switch (x){
                ...
                case NotePad.Notes.YELLOW_COLOR:
                    mText.setBackgroundColor(Color.rgb(250, 249, 222));
                    break;
                case NotePad.Notes.BLUE_COLOR:
                    mText.setBackgroundColor(Color.rgb(137, 171, 227));
                    break;
                case NotePad.Notes.GREEN_COLOR:
                    mText.setBackgroundColor(Color.rgb(204, 232, 207));
                    break;
                case NotePad.Notes.RED_COLOR:
                    mText.setBackgroundColor(Color.rgb(242, 221, 222));
                    break;
                case NotePad.Notes.PURPLE_COLOR:
                    mText.setBackgroundColor(Color.rgb(160, 32, 240));
                    break;
                case NotePad.Notes.GREY_COLOR:
                    mText.setBackgroundColor(Color.rgb(192, 192, 192));
                    break;
                default:
                    mText.setBackgroundColor(Color.rgb(255, 255, 255));
            }
            ...
            //读取字体数据
            int y = mCursor.getInt(mCursor.getColumnIndex(NotePad.Notes.COLUMN_NAME_FONT_SIZE));

            switch (y){
                case NotePad.Notes.FONT_20:
                    mText.setTextSize(20);
                    break;
                case NotePad.Notes.FONT_30:
                    mText.setTextSize(30);
                    break;
                case NotePad.Notes.FONT_40:
...
//END_INCLUDE(paste)
    ...
    */
        ...
        String dateTime = LongFormatTime(now);
    ...
    private final void changeFontSize(){
        Intent intent=new Intent(null,mUri);
        intent.setClass(NoteEditor.this,NoteFontSize.class);
        NoteEditor.this.startActivity(intent);
    }
